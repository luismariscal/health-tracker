...
// =========================================================
const SW_VERSION = "tp-sw-v2.38.5";
...
async function fireWaterReminderFromSW() {
  ...
  try {
    await self.registration.showNotification("💧 Time to hydrate", {
      ...
      badge:
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><text x="50%" y="65%" text-anchor="middle" font-size="36" fill="black">💧</text></svg>',
      tag: "tp-water-bg",
      renotify: false,
